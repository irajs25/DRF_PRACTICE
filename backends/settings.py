...
SECRET_KEY = 'django-insecure-pb4)xqpj*c7=sprwww&k_dk)ih($w)27f9f6qp6co3-zs(b5sm'
...
MIDDLEWARE = [
    ...
    # 'email_send_app.middlewares.my_middleware',
]
...
CELERY_BROKER_URL        = config('CELERY_BROKER_URL')
CELERY_RESULT_SERILAIZER = config('CELERY_RESULT_SERILAIZER')
CELERY_TASK_SERILAIZER   = config('CELERY_TASK_SERILAIZER')
